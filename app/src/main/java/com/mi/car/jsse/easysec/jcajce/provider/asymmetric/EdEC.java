...
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.edec.KeyFactorySpi;
...
public class EdEC
{
    private static final String PREFIX = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".edec.";
