...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        return new SecT193R1Point(curve, X3, (Z1IsOne ? X1 : X1.multiply(Z1)).squarePlusProduct(T, L1Z1).add(X3).add(Z3), new ECFieldElement[]{Z3});
    }
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (B.isZero()) {
            ...
            return new SecT193R1Point(curve, X3, A.add(B).square().multiplyPlusProduct(T, L2plus1, Z3), new ECFieldElement[]{Z3});
        }
    }
    ...
    public ECPoint negate() {
        ...
        ECFieldElement L = this.y;
        ECFieldElement Z = this.zs[0];
        return new SecT193R1Point(this.curve, X, L.add(Z), new ECFieldElement[]{Z});
    }
}
