package com.mi.car.jsse.easysec.jcajce.provider.asymmetric.x509;
    ...
    implements BCX509Certificate
{
    ...
    protected com.mi.car.jsse.easysec.asn1.x509.Certificate c;
    protected BasicConstraints basicConstraints;
    protected boolean[] keyUsage;
    protected String sigAlgName;
    protected byte[] sigAlgParams;
    X509CertificateImpl(JcaJceHelper bcHelper, com.mi.car.jsse.easysec.asn1.x509.Certificate c,
    ...
    public PublicKey getPublicKey()
    {
        try
        {
            return EasysecProvider.getPublicKey(c.getSubjectPublicKeyInfo());
        }
        catch (IOException e)
        {
    ...
    private boolean isAlgIdEqual(AlgorithmIdentifier id1, AlgorithmIdentifier id2)
    {
        ...
        if (Properties.isOverrideSet("com.mi.car.jsse.easysec.x509.allow_absent_equiv_NULL"))
        {
    ...
    private static Collection getAlternativeNames(com.mi.car.jsse.easysec.asn1.x509.Certificate c, String oid)
        throws CertificateParsingException
    {
    ...
    protected static byte[] getExtensionOctets(com.mi.car.jsse.easysec.asn1.x509.Certificate c, String oid)
    {
        ASN1OctetString extValue = getExtensionValue(c, oid);
        if (null != extValue)
        {
    ...
    protected static ASN1OctetString getExtensionValue(com.mi.car.jsse.easysec.asn1.x509.Certificate c, String oid)
    {
