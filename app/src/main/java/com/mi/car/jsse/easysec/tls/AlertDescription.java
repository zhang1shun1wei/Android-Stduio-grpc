...
public class AlertDescription {
    ...
    public static String getName(short alertDescription) {
        switch (alertDescription) {
            ...
            case NamedGroup.x448 /*{ENCODED_INT: 30}*/:
                return "decompression_failure";
            case NamedGroup.GC512C /*{ENCODED_INT: 40}*/:
                return "handshake_failure";
            case 41:
                return "no_certificate";
            case ExtensionType.early_data /*{ENCODED_INT: 42}*/:
                return "bad_certificate";
            case ExtensionType.supported_versions /*{ENCODED_INT: 43}*/:
                return "unsupported_certificate";
            case 44:
                return "certificate_revoked";
            case 45:
                return "certificate_expired";
            case CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA /*{ENCODED_INT: 46}*/:
            ...
            case CipherSuite.TLS_RSA_WITH_AES_128_CBC_SHA256 /*{ENCODED_INT: 60}*/:
                return "export_restriction";
            case CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA /*{ENCODED_INT: 70}*/:
            ...
            case CipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA256 /*{ENCODED_INT: 109}*/:
