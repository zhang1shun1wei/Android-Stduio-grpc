    ...
    extends SignatureSpi
{
    ...
    private com.mi.car.jsse.easysec.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return com.mi.car.jsse.easysec.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new com.mi.car.jsse.easysec.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(false, key);
        isInitState = true;
    }
