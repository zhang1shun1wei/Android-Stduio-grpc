 ...
 * <ul>
 * <li>MAC generation, by providing a {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setKey(byte[]) key}.</li>
 * <li>Randomised hashing, by providing a {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setNonce(byte[]) nonce}.</li>
 * <li>A hash function for digital signatures, associating a
 * {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setPublicKey(byte[]) public key} with the message digest.</li>
 * <li>A key derivation function, by providing a
 * {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setKeyIdentifier(byte[]) key identifier}.</li>
 * <li>Personalised hashing, by providing a
 * {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(java.util.Date, String, String) recommended format} or
 * {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec.Builder#setPersonalisation(byte[]) arbitrary} personalisation string.</li>
 * </ul>
 *
 * @see com.mi.car.jsse.easysec.crypto.digests.SkeinEngine
 * @see com.mi.car.jsse.easysec.crypto.digests.SkeinDigest
 * @see com.mi.car.jsse.easysec.crypto.macs.SkeinMac
 */
    ...
    implements AlgorithmParameterSpec
{
    ...
    /**
     * A builder for {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec}.
     */
    public static class Builder
    {
         ...
         * com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} (reserved for message body).
         * <p>
         * Parameters with type &lt; {@value com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE} are processed before
         * the message content, parameters with type &gt; {@value com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_MESSAGE}
        ...
        /**
         * Sets the {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY} parameter.
         */
        ...
        /**
         * Sets the {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_PERSONALISATION} parameter.
         */
        ...
        /**
         * Sets the {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_KEY_IDENTIFIER} parameter.
         *
         * @return the current builder instance.
         */
        ...
        /**
         * Sets the {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec#PARAM_TYPE_NONCE} parameter.
         *
         * @return the current builder instance.
         */
        ...
        /**
         * Constructs a new {@link com.mi.car.jsse.easysec.jcajce.spec.SkeinParameterSpec} instance with the parameters provided to this
         * builder.
         */
