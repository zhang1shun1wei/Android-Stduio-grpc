package com.mi.car.jsse.easysec.jcajce.provider.keystore.bc;
...
import com.mi.car.jsse.easysec.crypto.io.DigestInputStream;
import com.mi.car.jsse.easysec.crypto.io.DigestOutputStream;
import com.mi.car.jsse.easysec.crypto.io.MacInputStream;
import com.mi.car.jsse.easysec.crypto.io.MacOutputStream;
import com.mi.car.jsse.easysec.crypto.macs.HMac;
import com.mi.car.jsse.easysec.jcajce.io.CipherInputStream;
import com.mi.car.jsse.easysec.jcajce.io.CipherOutputStream;
    ...
    implements BCKeyStore
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            {
            case KEY_PRIVATE:
                return EasysecProvider.getPrivateKey(PrivateKeyInfo.getInstance(enc));
            case KEY_PUBLIC:
                return  EasysecProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(enc));
            case KEY_SECRET:
        ...
        extends BcKeyStoreSpi
    {
        ...
        {
            super(1);
            if (!Properties.isOverrideSet("com.mi.car.jsse.easysec.bks.enable_v1"))
            {
