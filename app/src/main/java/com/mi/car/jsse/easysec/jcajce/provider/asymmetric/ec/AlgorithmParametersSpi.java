    ...
    extends java.security.AlgorithmParametersSpi
{
        ...
        throws InvalidParameterSpecException
    {
        if (algorithmParameterSpec instanceof ECGenParameterSpec)
        {
            ...
            ProviderConfiguration configuration = EasysecProvider.CONFIGURATION;
        ...
        throws IOException
    {
        if (isASN1FormatString(format))
        {
            ...
            ECCurve curve = EC5Util.getCurve(EasysecProvider.CONFIGURATION, params);
        ...
        throws IOException
    {
        if (isASN1FormatString(format))
        {
            ...
            {
                com.mi.car.jsse.easysec.jce.spec.ECParameterSpec ecSpec = EC5Util.convertSpec(ecParameterSpec);
