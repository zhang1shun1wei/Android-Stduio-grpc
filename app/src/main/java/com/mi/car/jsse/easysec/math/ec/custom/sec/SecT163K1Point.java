...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        return new SecT163K1Point(curve, X3, t1.add(T).add(Z1Sq).multiply(t1).add(X3), new ECFieldElement[]{Z3});
    }
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (B.isZero()) {
            ...
            return new SecT163K1Point(curve, X3, A.add(B).square().multiplyPlusProduct(T, L2.addOne(), Z3), new ECFieldElement[]{Z3});
        }
    }
