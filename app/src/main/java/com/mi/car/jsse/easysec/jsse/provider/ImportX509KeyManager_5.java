...
public final class ImportX509KeyManager_5 extends BCX509ExtendedKeyManager implements ImportX509KeyManager {
    final X509ExtendedKeyManager x509KeyManager;

    ImportX509KeyManager_5(X509ExtendedKeyManager x509KeyManager2) {
    ...
    public String chooseEngineClientAlias(String[] keyType, Principal[] issuers, SSLEngine engine) {
        return this.x509KeyManager.chooseEngineClientAlias(keyType, issuers, engine);
    }

    public String chooseEngineServerAlias(String keyType, Principal[] issuers, SSLEngine engine) {
        return this.x509KeyManager.chooseEngineServerAlias(keyType, issuers, engine);
    }
    ...
    public BCX509Key validateKeyBC(boolean forServer, String keyType, String alias, SSLEngine engine) {
        return ProvX509Key.validate(this.x509KeyManager, forServer, keyType, alias, TransportData.from(engine));
    }
}
