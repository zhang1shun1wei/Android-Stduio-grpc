...
public abstract class ASN1VisibleString extends ASN1Primitive implements ASN1String {
    static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1VisibleString.class, 26) {
        /* class com.mi.car.jsse.easysec.asn1.ASN1VisibleString.AnonymousClass1 */
    ...
    ASN1VisibleString(byte[] contents2, boolean clone) {
    ...
    public final boolean asn1Equals(ASN1Primitive other) {
        ...
        return Arrays.areEqual(this.contents, ((ASN1VisibleString) other).contents);
    }
    ...
    static ASN1VisibleString createPrimitive(byte[] contents2) {
        return new DERVisibleString(contents2, false);
    }
}
