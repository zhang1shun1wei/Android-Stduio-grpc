...
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".gost.";
