...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    @Override // com.mi.car.jsse.easysec.crypto.engines.SerpentEngineBase
    ...
    public void encryptBlock(byte[] input, int inOff, byte[] output, int outOff) {
        int[] X = {Pack.littleEndianToInt(input, inOff), Pack.littleEndianToInt(input, inOff + 4), Pack.littleEndianToInt(input, inOff + 8), Pack.littleEndianToInt(input, inOff + 12)};
        sb0(X, X[0] ^ this.wKey[0], X[1] ^ this.wKey[1], X[2] ^ this.wKey[2], X[3] ^ this.wKey[3]);
        LT(X);
        sb1(X, X[0] ^ this.wKey[4], X[1] ^ this.wKey[5], X[2] ^ this.wKey[6], X[3] ^ this.wKey[7]);
        LT(X);
        sb2(X, X[0] ^ this.wKey[8], X[1] ^ this.wKey[9], X[2] ^ this.wKey[10], X[3] ^ this.wKey[11]);
        LT(X);
        sb3(X, X[0] ^ this.wKey[12], X[1] ^ this.wKey[13], X[2] ^ this.wKey[14], X[3] ^ this.wKey[15]);
        LT(X);
        sb4(X, X[0] ^ this.wKey[16], X[1] ^ this.wKey[17], X[2] ^ this.wKey[18], X[3] ^ this.wKey[19]);
        LT(X);
        sb5(X, X[0] ^ this.wKey[20], X[1] ^ this.wKey[21], X[2] ^ this.wKey[22], X[3] ^ this.wKey[23]);
        LT(X);
        sb6(X, X[0] ^ this.wKey[24], X[1] ^ this.wKey[25], X[2] ^ this.wKey[26], X[3] ^ this.wKey[27]);
        LT(X);
        sb7(X, X[0] ^ this.wKey[28], X[1] ^ this.wKey[29], X[2] ^ this.wKey[30], X[3] ^ this.wKey[31]);
        LT(X);
        sb0(X, X[0] ^ this.wKey[32], X[1] ^ this.wKey[33], X[2] ^ this.wKey[34], X[3] ^ this.wKey[35]);
        LT(X);
        sb1(X, X[0] ^ this.wKey[36], X[1] ^ this.wKey[37], X[2] ^ this.wKey[38], X[3] ^ this.wKey[39]);
        LT(X);
        sb2(X, X[0] ^ this.wKey[40], X[1] ^ this.wKey[41], X[2] ^ this.wKey[42], X[3] ^ this.wKey[43]);
        LT(X);
        sb3(X, X[0] ^ this.wKey[44], X[1] ^ this.wKey[45], X[2] ^ this.wKey[46], X[3] ^ this.wKey[47]);
        LT(X);
        sb4(X, X[0] ^ this.wKey[48], X[1] ^ this.wKey[49], X[2] ^ this.wKey[50], X[3] ^ this.wKey[51]);
        LT(X);
        sb5(X, X[0] ^ this.wKey[52], X[1] ^ this.wKey[53], X[2] ^ this.wKey[54], X[3] ^ this.wKey[55]);
        LT(X);
        sb6(X, X[0] ^ this.wKey[56], X[1] ^ this.wKey[57], X[2] ^ this.wKey[58], X[3] ^ this.wKey[59]);
        LT(X);
        sb7(X, X[0] ^ this.wKey[60], X[1] ^ this.wKey[61], X[2] ^ this.wKey[62], X[3] ^ this.wKey[63]);
        LT(X);
        sb0(X, X[0] ^ this.wKey[64], X[1] ^ this.wKey[65], X[2] ^ this.wKey[66], X[3] ^ this.wKey[67]);
        LT(X);
        sb1(X, X[0] ^ this.wKey[68], X[1] ^ this.wKey[69], X[2] ^ this.wKey[70], X[3] ^ this.wKey[71]);
        LT(X);
        sb2(X, X[0] ^ this.wKey[72], X[1] ^ this.wKey[73], X[2] ^ this.wKey[74], X[3] ^ this.wKey[75]);
        LT(X);
        sb3(X, X[0] ^ this.wKey[76], X[1] ^ this.wKey[77], X[2] ^ this.wKey[78], X[3] ^ this.wKey[79]);
        LT(X);
        sb4(X, X[0] ^ this.wKey[80], X[1] ^ this.wKey[81], X[2] ^ this.wKey[82], X[3] ^ this.wKey[83]);
        LT(X);
        sb5(X, X[0] ^ this.wKey[84], X[1] ^ this.wKey[85], X[2] ^ this.wKey[86], X[3] ^ this.wKey[87]);
        LT(X);
        sb6(X, X[0] ^ this.wKey[88], X[1] ^ this.wKey[89], X[2] ^ this.wKey[90], X[3] ^ this.wKey[91]);
        LT(X);
        sb7(X, X[0] ^ this.wKey[92], X[1] ^ this.wKey[93], X[2] ^ this.wKey[94], X[3] ^ this.wKey[95]);
        LT(X);
        sb0(X, X[0] ^ this.wKey[96], X[1] ^ this.wKey[97], X[2] ^ this.wKey[98], X[3] ^ this.wKey[99]);
        LT(X);
        sb1(X, X[0] ^ this.wKey[100], X[1] ^ this.wKey[101], X[2] ^ this.wKey[102], X[3] ^ this.wKey[103]);
        LT(X);
        sb2(X, X[0] ^ this.wKey[104], X[1] ^ this.wKey[105], X[2] ^ this.wKey[106], X[3] ^ this.wKey[107]);
        LT(X);
        sb3(X, X[0] ^ this.wKey[108], X[1] ^ this.wKey[109], X[2] ^ this.wKey[110], X[3] ^ this.wKey[111]);
        LT(X);
        sb4(X, X[0] ^ this.wKey[112], X[1] ^ this.wKey[113], X[2] ^ this.wKey[114], X[3] ^ this.wKey[115]);
        LT(X);
        sb5(X, X[0] ^ this.wKey[116], X[1] ^ this.wKey[117], X[2] ^ this.wKey[118], X[3] ^ this.wKey[119]);
        LT(X);
        sb6(X, X[0] ^ this.wKey[120], X[1] ^ this.wKey[121], X[2] ^ this.wKey[122], X[3] ^ this.wKey[123]);
        LT(X);
        sb7(X, X[0] ^ this.wKey[124], X[1] ^ this.wKey[125], X[2] ^ this.wKey[126], X[3] ^ this.wKey[127]);
    ...
    public void decryptBlock(byte[] input, int inOff, byte[] output, int outOff) {
        int[] X = {this.wKey[128] ^ Pack.littleEndianToInt(input, inOff), this.wKey[129] ^ Pack.littleEndianToInt(input, inOff + 4), this.wKey[130] ^ Pack.littleEndianToInt(input, inOff + 8), this.wKey[131] ^ Pack.littleEndianToInt(input, inOff + 12)};
