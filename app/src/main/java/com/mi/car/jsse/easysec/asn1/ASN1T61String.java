...
public abstract class ASN1T61String extends ASN1Primitive implements ASN1String {
    static final ASN1UniversalType TYPE = new ASN1UniversalType(ASN1T61String.class, 20) {
        /* class com.mi.car.jsse.easysec.asn1.ASN1T61String.AnonymousClass1 */
    ...
    ASN1T61String(byte[] contents2, boolean clone) {
    ...
    public final boolean asn1Equals(ASN1Primitive other) {
        ...
        return Arrays.areEqual(this.contents, ((ASN1T61String) other).contents);
    }
    ...
    static ASN1T61String createPrimitive(byte[] contents2) {
        return new DERT61String(contents2, false);
    }
}
