...
public class DESEngine implements BlockCipher {
    ...
    public void desFunc(int[] wKey, byte[] in, int inOff, byte[] out, int outOff) {
        ...
        int work2 = ((left2 >>> 16) ^ right2) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        ...
        int work13 = ((right11 >>> 16) ^ left11) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
