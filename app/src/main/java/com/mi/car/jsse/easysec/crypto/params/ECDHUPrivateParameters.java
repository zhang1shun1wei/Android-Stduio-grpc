...
public class ECDHUPrivateParameters implements CipherParameters {
    ...
    public ECDHUPrivateParameters(ECPrivateKeyParameters staticPrivateKey2, ECPrivateKeyParameters ephemeralPrivateKey2) {
        this(staticPrivateKey2, ephemeralPrivateKey2, null);
    }

    public ECDHUPrivateParameters(ECPrivateKeyParameters staticPrivateKey2, ECPrivateKeyParameters ephemeralPrivateKey2, ECPublicKeyParameters ephemeralPublicKey2) {
