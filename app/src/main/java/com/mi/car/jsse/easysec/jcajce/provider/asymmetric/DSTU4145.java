...
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".dstu.";
