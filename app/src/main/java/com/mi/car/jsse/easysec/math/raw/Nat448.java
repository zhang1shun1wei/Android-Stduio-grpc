...
public abstract class Nat448 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        int c212 = c21 + Nat224.addTo(zz, 21, zz, 14, c21 + Nat224.addTo(zz, 0, zz, 7, 0));
        ...
        Nat224.mul(dx, dy, tt);
        Nat.addWordAt(28, c212 + (neg ? Nat.addTo(14, tt, 0, zz, 7) : Nat.subFrom(14, tt, 0, zz, 7)), zz, 21);
    }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        int[] tt = Nat224.createExt();
        Nat224.square(dx, tt);
        Nat.addWordAt(28, c21 + Nat224.addTo(zz, 21, zz, 14, c21 + Nat224.addTo(zz, 0, zz, 7, 0)) + Nat.subFrom(14, tt, 0, zz, 7), zz, 21);
    }
