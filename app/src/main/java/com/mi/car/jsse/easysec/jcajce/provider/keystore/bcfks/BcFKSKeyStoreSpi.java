package com.mi.car.jsse.easysec.jcajce.provider.keystore.bcfks;
...
import com.mi.car.jsse.easysec.asn1.bc.EncryptedObjectStoreData;
import com.mi.car.jsse.easysec.asn1.bc.EncryptedPrivateKeyData;
import com.mi.car.jsse.easysec.asn1.bc.EncryptedSecretKeyData;
import com.mi.car.jsse.easysec.asn1.bc.ObjectData;
import com.mi.car.jsse.easysec.asn1.bc.ObjectDataSequence;
import com.mi.car.jsse.easysec.asn1.bc.ObjectStore;
import com.mi.car.jsse.easysec.asn1.bc.ObjectStoreData;
import com.mi.car.jsse.easysec.asn1.bc.ObjectStoreIntegrityCheck;
import com.mi.car.jsse.easysec.asn1.bc.PbkdMacIntegrityCheck;
import com.mi.car.jsse.easysec.asn1.bc.SecretKeyData;
import com.mi.car.jsse.easysec.asn1.bc.SignatureCheck;
...
import com.mi.car.jsse.easysec.asn1.misc.ScryptParams;
import com.mi.car.jsse.easysec.asn1.nist.NISTObjectIdentifiers;
import com.mi.car.jsse.easysec.asn1.nsri.NSRIObjectIdentifiers;
...
import com.mi.car.jsse.easysec.asn1.pkcs.EncryptionScheme;
import com.mi.car.jsse.easysec.asn1.pkcs.KeyDerivationFunc;
import com.mi.car.jsse.easysec.asn1.pkcs.PBES2Parameters;
import com.mi.car.jsse.easysec.asn1.pkcs.PBKDF2Params;
...
import com.mi.car.jsse.easysec.crypto.generators.SCrypt;
import com.mi.car.jsse.easysec.crypto.params.KeyParameter;
import com.mi.car.jsse.easysec.crypto.util.PBKDF2Config;
import com.mi.car.jsse.easysec.crypto.util.PBKDFConfig;
import com.mi.car.jsse.easysec.crypto.util.ScryptConfig;
import com.mi.car.jsse.easysec.jcajce.BCFKSLoadStoreParameter;
import com.mi.car.jsse.easysec.jcajce.BCFKSStoreParameter;
import com.mi.car.jsse.easysec.jcajce.BCLoadStoreParameter;
import com.mi.car.jsse.easysec.jcajce.provider.keystore.util.AdaptingKeyStoreSpi;
import com.mi.car.jsse.easysec.jcajce.provider.keystore.util.ParameterUtil;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                com.mi.car.jsse.easysec.asn1.x509.Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (helper != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(com.mi.car.jsse.easysec.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        com.mi.car.jsse.easysec.asn1.x509.Certificate[] certChain = new com.mi.car.jsse.easysec.asn1.x509.Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = com.mi.car.jsse.easysec.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
        ...
        else if (parameter instanceof BCFKSLoadStoreParameter)
        {
            ...
            if (bcParam.getStoreSignatureKey() != null)
            {
                ...
                try
                {
                    ...
                    if (certs != null)
                    {
                        com.mi.car.jsse.easysec.asn1.x509.Certificate[] certificates = new com.mi.car.jsse.easysec.asn1.x509.Certificate[certs.length];
                        for (int i = 0; i != certificates.length; i++)
                        {
                            certificates[i] = com.mi.car.jsse.easysec.asn1.x509.Certificate.getInstance(certs[i].getEncoded());
                        }
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        else if (integrityCheck.getType() == ObjectStoreIntegrityCheck.SIG_CHECK)
        {
            ...
            try
            {
                com.mi.car.jsse.easysec.asn1.x509.Certificate[] certificates = sigCheck.getCertificates();
                if (validator != null)
                {
