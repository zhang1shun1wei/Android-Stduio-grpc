            ...
            if (this.isInfinity()) {
                ...
                switch(coord) {
                    case 0:
                        ...
                        return new ECPoint.F2m(curve, U2, S2);
                    case 1:
                        L1 = this.y;
                        Z1 = this.zs[0];
                        L2 = b.y;
                        ...
                        Y3 = X3.multiply(L3);
                        return new ECPoint.F2m(curve, AU2, L, new ECFieldElement[]{Y3});
                    case 6:
                        if (X1.isZero()) {
                            if (X2.isZero()) {
                                return curve.getInfinity();
                ...
                if (X1.isZero()) {
                    ...
                    switch(coord) {
                        case 0:
                            ...
                            ECFieldElement X3 = Z1.square().add(Z1).add(curve.getA());
                            L1Z1 = X1.squarePlusProduct(X3, Z1.addOne());
                            return new ECPoint.F2m(curve, X3, L1Z1);
                        case 1:
                            L1 = this.y;
                            Z1 = this.zs[0];
                            Z1IsOne = Z1.isOne();
                            ...
                            L3 = L1Z1.multiply(b);
                            t1 = a.square().multiplyPlusProduct(L1Z1, b, Z3);
                            t2 = L1Z1.multiply(X3);
                            return new ECPoint.F2m(curve, L3, t1, new ECFieldElement[]{t2});
                        case 6:
                            L1 = this.y;
                            Z1 = this.zs[0];
                            Z1IsOne = Z1.isOne();
            ...
            if (this.isInfinity()) {
                ...
                if (X.isZero()) {
                    ...
                    switch(this.getCurveCoordinateSystem()) {
                        case 0:
                            L = this.y;
                            return new ECPoint.F2m(this.curve, X, L.add(X));
                        case 1:
                            L = this.y;
                            Z = this.zs[0];
                            return new ECPoint.F2m(this.curve, X, L.add(X), new ECFieldElement[]{Z});
                        case 2:
                        case 3:
                        case 4:
                        default:
                        ...
                        case 5:
                            L = this.y;
                            return new ECPoint.F2m(this.curve, X, L.addOne());
                        case 6:
                            L = this.y;
                            Z = this.zs[0];
                            return new ECPoint.F2m(this.curve, X, L.add(Z), new ECFieldElement[]{Z});
                    }
                }
            }
        }
    ...
    public abstract static class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            if (coord == 6) {
                ...
                Z = this.y;
                ECFieldElement lhs = Z.add(X).multiply(Z);
                switch(coord) {
                    case 1:
                        Z = this.zs[0];
                        if (!Z.isOne()) {
        ...
        protected boolean satisfiesOrder() {
            ...
            if (ECConstants.TWO.equals(cofactor)) {
                N = this.normalize();
                X = N.getAffineXCoord();
                return 0 != ((com.mi.car.jsse.easysec.math.ec.ECFieldElement.AbstractF2m)X).trace();
            } else if (ECConstants.FOUR.equals(cofactor)) {
                N = this.normalize();
                X = N.getAffineXCoord();
                ECFieldElement L = ((com.mi.car.jsse.easysec.math.ec.ECCurve.AbstractF2m)this.curve).solveQuadraticEquation(X.add(this.curve.getA()));
                if (null == L) {
                    return false;
                } else {
                    ECFieldElement Y = N.getAffineYCoord();
                    ECFieldElement T = X.multiply(L).add(Y);
                    return 0 == ((com.mi.car.jsse.easysec.math.ec.ECFieldElement.AbstractF2m)T).trace();
                }
            } else {
            ...
            if (this.isInfinity()) {
                ...
                switch(coord) {
                    case 5:
                        ...
                        return this.getCurve().createRawPoint(X, X2, this.getRawZCoords());
                    case 6:
                        X = this.getRawXCoord();
                        L = this.getRawYCoord();
            ...
            if (this.isInfinity()) {
                ...
                switch(coord) {
                    ...
                    case 6:
                        Y1 = this.y;
                        ECFieldElement Z1 = this.zs[0];
                        return (ECPoint.AbstractF2m)curve.createRawPoint(X1.squarePow(pow), Y1.squarePow(pow), new ECFieldElement[]{Z1.squarePow(pow)});
                    case 2:
                    case 3:
                    case 4:
                    default:
    ...
    public static class Fp extends ECPoint.AbstractFp {
            ...
            if (this.isInfinity()) {
                ...
                switch(coord) {
                    ...
                    case 1:
                        ...
                        U2 = Z2IsOne ? X1 : X1.multiply(Z2);
                        S2 = Z1Squared.subtract(U2);
                        if (S2.isZero()) {
                            if (Z3Squared.isZero()) {
                                return this.twice();
                            }
                        ...
                        return new ECPoint.Fp(curve, R, HSquared, new ECFieldElement[]{G});
                    case 2:
                    case 4:
                        Z1 = this.zs[0];
                        Z2 = b.zs[0];
                        ...
                        if (!Z1IsOne && Z1.equals(Z2)) {
                            ...
                            X3 = U2.square().subtract(Z1Cubed).subtract(Z2Squared);
                            Y3 = Z1Cubed.subtract(X3).multiply(U2).subtract(U1);
                            Z3 = Z1Squared.multiply(Z1);
                        } else {
                            if (Z1IsOne) {
                                U2 = X2;
                                S2 = Y2;
                        ...
                        ECFieldElement[] zs;
                        if (coord == 4) {
                            U2 = this.calculateJacobianModifiedW(Z3, Z3Squared);
                            zs = new ECFieldElement[]{Z3, U2};
                        } else {
                ...
                if (Y1.isZero()) {
                    ...
                    switch(coord) {
                        case 0:
                            ...
                            return new ECPoint.Fp(curve, Y1Squared, T);
                        case 1:
                            Z1 = this.zs[0];
                            Z1IsOne = Z1.isOne();
                            ...
                            return new ECPoint.Fp(curve, Z1Squared, Y3, new ECFieldElement[]{Z3});
                        case 2:
                            Z1 = this.zs[0];
                            Z1IsOne = Z1.isOne();
                            Y1Squared = Y1.square();
                            ...
                            return new ECPoint.Fp(curve, X3, Z1Squared, new ECFieldElement[]{Z1Pow4});
                        case 3:
                        default:
                            throw new IllegalStateException("unsupported coordinate system");
                        case 4:
                    ...
                    if (Y1.isZero()) {
                        ...
                        switch(coord) {
                            case 0:
                                ...
                                return new ECPoint.Fp(curve, X1.multiply(zInv2), Y1.multiply(M));
                            case 1:
                                X1 = X1.multiply(Z1);
                                Z1 = Z1.multiply(Z1.square());
                                return new ECPoint.Fp(curve, X1, Y1, new ECFieldElement[]{Z1});
                            case 2:
                                return new ECPoint.Fp(curve, X1, Y1, new ECFieldElement[]{Z1});
                            case 3:
                            default:
                                throw new IllegalStateException("unsupported coordinate system");
                            case 4:
                                return new ECPoint.Fp(curve, X1, Y1, new ECFieldElement[]{Z1, W1});
                        }
                    }
                }
            } else {
        ...
        public ECPoint negate() {
            if (this.isInfinity()) {
                ...
                ECCurve curve = this.getCurve();
                int coord = curve.getCoordinateSystem();
                return 0 != coord ? new ECPoint.Fp(curve, this.x, this.y.negate(), this.zs) : new ECPoint.Fp(curve, this.x, this.y.negate());
            }
        }
