    ...
    implements RSAPrivateKey, PKCS12BagAttributeCarrier
{
    ...
    BCRSAPrivateKey(AlgorithmIdentifier algID, com.mi.car.jsse.easysec.asn1.pkcs.RSAPrivateKey key)
    {
        this.algorithmIdentifier = algID;
        this.algorithmIdentifierEnc = getEncoding(algID);
    ...
    {
        return KeyUtil.getEncodedPrivateKeyInfo(algorithmIdentifier, new com.mi.car.jsse.easysec.asn1.pkcs.RSAPrivateKey(getModulus(), ZERO, getPrivateExponent(), ZERO, ZERO, ZERO, ZERO, ZERO));
    }
