package com.mi.car.jsse.easysec.jcajce.provider.asymmetric.dstu;
...
public class BCDSTU4145PrivateKey
    implements ECPrivateKey, com.mi.car.jsse.easysec.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCDSTU4145PrivateKey(
        com.mi.car.jsse.easysec.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
    ...
    public BCDSTU4145PrivateKey(
        ...
        ECPrivateKeyParameters params,
        BCDSTU4145PublicKey pubKey,
        com.mi.car.jsse.easysec.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters dp = params.getParameters();
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    spec = new com.mi.car.jsse.easysec.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
                }
        ...
        {
            com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey ec = com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        if (ecSpec instanceof ECNamedCurveSpec)
        {
            ...
            orderBitLength = ECUtil.getOrderBitLength(EasysecProvider.CONFIGURATION, ecSpec.getOrder(), this.getS());
        }
        else if (ecSpec == null)
        {
            params = new X962Parameters(DERNull.INSTANCE);
            orderBitLength = ECUtil.getOrderBitLength(EasysecProvider.CONFIGURATION, null, this.getS());
        }
        else
        {
        ...
        PrivateKeyInfo info;
        com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey keyStructure;

        if (publicKey != null)
        {
            keyStructure = new com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
        }
        else
        {
            keyStructure = new com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
        }
    ...
    com.mi.car.jsse.easysec.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec);
