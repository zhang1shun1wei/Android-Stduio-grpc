package com.mi.car.jsse.easysec.jcajce.provider.keystore.pkcs12;
...
import com.mi.car.jsse.easysec.asn1.cryptopro.GOST28147Parameters;
...
import com.mi.car.jsse.easysec.asn1.pkcs.AuthenticatedSafe;
import com.mi.car.jsse.easysec.asn1.pkcs.CertBag;
import com.mi.car.jsse.easysec.asn1.pkcs.ContentInfo;
import com.mi.car.jsse.easysec.asn1.pkcs.EncryptedData;
...
import com.mi.car.jsse.easysec.asn1.x509.ExtendedKeyUsage;
...
import com.mi.car.jsse.easysec.jcajce.PKCS12StoreParameter;
...
import com.mi.car.jsse.easysec.jcajce.spec.PBKDF2KeySpec;
...
import com.mi.car.jsse.easysec.jce.interfaces.BCKeyStore;
...
import com.mi.car.jsse.easysec.jce.provider.JDKPKCS12StoreParameter;
...
{
    static final String PKCS12_MAX_IT_COUNT_PROPERTY = "com.mi.car.jsse.easysec.pkcs12.max_it_count";
        ...
        throws IOException
    {
        ...
        {
            if (!Properties.isOverrideSet("com.mi.car.jsse.easysec.pkcs12.ignore_useless_passwd"))
            {
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.mi.car.jsse.easysec.asn1.pkcs.EncryptedPrivateKeyInfo eIn = com.mi.car.jsse.easysec.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.mi.car.jsse.easysec.asn1.pkcs.PrivateKeyInfo kInfo = com.mi.car.jsse.easysec.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
                            PrivateKey privKey = EasysecProvider.getPrivateKey(kInfo);
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            com.mi.car.jsse.easysec.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new com.mi.car.jsse.easysec.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
