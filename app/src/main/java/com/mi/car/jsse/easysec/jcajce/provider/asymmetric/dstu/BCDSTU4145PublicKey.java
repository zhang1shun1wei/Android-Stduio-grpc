...
public class BCDSTU4145PublicKey
    implements ECPublicKey, com.mi.car.jsse.easysec.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    public BCDSTU4145PublicKey(
        com.mi.car.jsse.easysec.jce.spec.ECPublicKeySpec spec,
        ProviderConfiguration configuration)
    {
        ...
        {
            com.mi.car.jsse.easysec.jce.spec.ECParameterSpec s = configuration.getEcImplicitlyCa();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        com.mi.car.jsse.easysec.jce.spec.ECParameterSpec spec = null;
        X9ECParameters x9Params = null;

        if (seq.getObjectAt(0) instanceof ASN1Integer)
        {
            x9Params = X9ECParameters.getInstance(seq);
            spec = new  com.mi.car.jsse.easysec.jce.spec.ECParameterSpec(x9Params.getCurve(), x9Params.getG(), x9Params.getN(), x9Params.getH(), x9Params.getSeed());
        }
        else
        {
    ...
    public com.mi.car.jsse.easysec.math.ec.ECPoint getQ()
    {
        com.mi.car.jsse.easysec.math.ec.ECPoint q = ecPublicKey.getQ();
