...
import com.mi.car.jsse.easysec.crypto.generators.DSAKeyPairGenerator;
import com.mi.car.jsse.easysec.crypto.generators.DSAParametersGenerator;
    ...
    extends java.security.KeyPairGenerator
{
        ...
        SecureRandom random)
    {
        ...
        DSAParameterSpec spec = EasysecProvider.CONFIGURATION.getDSADefaultParameters(strength);
                ...
                synchronized (lock)
                {
                    ...
                    else
                    {
                        ...
                        if (strength == 1024)
                        {
                            ...
                            if (Properties.isOverrideSet("com.mi.car.jsse.easysec.dsa.FIPS186-2for1024bits"))
                            {
