...
public class SecT131R1Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        return new AbstractECLookupTable() {
            /* class com.mi.car.jsse.easysec.math.ec.custom.sec.SecT131R1Curve.AnonymousClass1 */
            ...
            private ECPoint createPoint(long[] x, long[] y) {
                return SecT131R1Curve.this.createRawPoint(new SecT131FieldElement(x), new SecT131FieldElement(y), SecT131R1Curve.SECT131R1_AFFINE_ZS);
            }
        };
    }
}
