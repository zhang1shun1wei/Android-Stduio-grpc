...
public class SecT163R2Curve extends ECCurve.AbstractF2m {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] points, int off, final int len) {
        ...
        return new AbstractECLookupTable() {
            /* class com.mi.car.jsse.easysec.math.ec.custom.sec.SecT163R2Curve.AnonymousClass1 */
            ...
            private ECPoint createPoint(long[] x, long[] y) {
                return SecT163R2Curve.this.createRawPoint(new SecT163FieldElement(x), new SecT163FieldElement(y), SecT163R2Curve.SECT163R2_AFFINE_ZS);
            }
        };
    }
}
