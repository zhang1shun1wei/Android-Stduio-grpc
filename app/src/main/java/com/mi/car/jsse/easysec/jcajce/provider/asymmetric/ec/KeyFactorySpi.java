...
import com.mi.car.jsse.easysec.crypto.util.OpenSSHPublicKeyUtil;
...
import com.mi.car.jsse.easysec.jcajce.spec.OpenSSHPrivateKeySpec;
import com.mi.car.jsse.easysec.jcajce.spec.OpenSSHPublicKeySpec;
...
import com.mi.car.jsse.easysec.jce.spec.ECPublicKeySpec;
    ...
    implements AsymmetricKeyInfoConverter
{
        ...
        throws InvalidKeySpecException
    {
        if ((spec.isAssignableFrom(KeySpec.class) || spec.isAssignableFrom(java.security.spec.ECPublicKeySpec.class)) && key instanceof ECPublicKey)
        {
            ...
            {
                ECParameterSpec implicitSpec = EasysecProvider.CONFIGURATION.getEcImplicitlyCa();
        ...
        else if (spec.isAssignableFrom(com.mi.car.jsse.easysec.jce.spec.ECPublicKeySpec.class) && key instanceof ECPublicKey)
        {
            ECPublicKey k = (ECPublicKey)key;
            if (k.getParams() != null)
            {
                return new com.mi.car.jsse.easysec.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW()), EC5Util.convertSpec(k.getParams()));
            }
            else
            {
                ECParameterSpec implicitSpec = EasysecProvider.CONFIGURATION.getEcImplicitlyCa();

                return new com.mi.car.jsse.easysec.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW()), implicitSpec);
            }
        }
        else if (spec.isAssignableFrom(com.mi.car.jsse.easysec.jce.spec.ECPrivateKeySpec.class) && key instanceof ECPrivateKey)
        {
            ECPrivateKey k = (ECPrivateKey)key;

            if (k.getParams() != null)
            {
                return new com.mi.car.jsse.easysec.jce.spec.ECPrivateKeySpec(k.getS(), EC5Util.convertSpec(k.getParams()));
            }
            else
            {
                ECParameterSpec implicitSpec = EasysecProvider.CONFIGURATION.getEcImplicitlyCa();

                return new com.mi.car.jsse.easysec.jce.spec.ECPrivateKeySpec(k.getS(), implicitSpec);
            }
        }
        ...
        throws InvalidKeySpecException
    {
        ...
        {
            com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey ecKey = com.mi.car.jsse.easysec.asn1.sec.ECPrivateKey.getInstance(((OpenSSHPrivateKeySpec)keySpec).getEncoded());
        ...
        extends KeyFactorySpi
    {
        public EC()
        {
            super("EC", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDSA()
        {
            super("ECDSA", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECGOST3410()
        {
            super("ECGOST3410", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        ...
        {
            super("ECGOST3410-2012", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDH()
        {
            super("ECDH", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDHC()
        {
            super("ECDHC", EasysecProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECMQV()
        {
            super("ECMQV", EasysecProvider.CONFIGURATION);
        }
    }
}