...
import com.mi.car.jsse.easysec.crypto.generators.DSTU4145KeyPairGenerator;
import com.mi.car.jsse.easysec.crypto.generators.ECKeyPairGenerator;
import com.mi.car.jsse.easysec.crypto.params.DSTU4145Parameters;
...
import com.mi.car.jsse.easysec.jcajce.spec.DSTU4145ParameterSpec;
    ...
    extends java.security.KeyPairGenerator
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        else if (params == null && EasysecProvider.CONFIGURATION.getEcImplicitlyCa() != null)
        {
            ECParameterSpec p = EasysecProvider.CONFIGURATION.getEcImplicitlyCa();
            this.ecParams = params;
