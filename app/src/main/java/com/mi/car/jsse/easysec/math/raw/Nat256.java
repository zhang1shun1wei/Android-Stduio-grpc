...
public abstract class Nat256 {
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            zz[i + 7] = (int) c8;
            long zc2 = zc + (((long) zz[i + 8]) & M) + (c8 >>> 32);
            zz[i + 8] = (int) zc2;
            zc = zc2 >>> 32;
        }
        return (int) zc;
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            zz[zzOff + 7] = (int) c8;
            long zc2 = zc + (((long) zz[zzOff + 8]) & M) + (c8 >>> 32);
            zz[zzOff + 8] = (int) zc2;
            zc = zc2 >>> 32;
            zzOff++;
        }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        while (true) {
            ...
            if (i2 <= 0) {
                ...
                long zz_125 = zz_124 + (zz_115 >>> 32) + (x_7 * x_5);
                long zz_133 = zz_132 + (zz_125 >>> 32) + (x_7 * x_6);
