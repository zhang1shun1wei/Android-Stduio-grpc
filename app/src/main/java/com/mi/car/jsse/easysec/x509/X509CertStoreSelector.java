 ...
 * 
 * @see com.mi.car.jsse.easysec.util.Selector
 * @see com.mi.car.jsse.easysec.x509.X509Store
 * @see com.mi.car.jsse.easysec.jce.provider.X509StoreCertCollection
 * @deprecated use the classes under com.mi.car.jsse.easysec.cert.selector
 */
