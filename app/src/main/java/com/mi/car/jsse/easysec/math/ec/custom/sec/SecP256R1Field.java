...
public class SecP256R1Field {
    ...
    static final int[] P = {P7, P7, P7, 0, 0, 0, 1, P7};
    private static final int[] PExt = {1, 0, 0, -2, P7, P7, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};
    ...
    public static void addOne(int[] x, int[] z) {
        if (Nat.inc(8, x, z) != 0 || (z[7] == P7 && Nat256.gte(z, P))) {
            addPInvTo(z);
        }
    }
