...
public class SSHNamedCurves {
    private static HashMap<ECCurve, String> curveMap = new HashMap<ECCurve, String>() {
        /* class com.mi.car.jsse.easysec.crypto.util.SSHNamedCurves.AnonymousClass3 */

        {
            Enumeration<Object> e = CustomNamedCurves.getNames();
            while (e.hasMoreElements()) {
                String name = (String) e.nextElement();
                put(CustomNamedCurves.getByNameLazy(name).getCurve(), name);
            }
        }
    };
    private static final Map<String, String> curveNameToSSHName = Collections.unmodifiableMap(new HashMap<String, String>() {
        /* class com.mi.car.jsse.easysec.crypto.util.SSHNamedCurves.AnonymousClass2 */
    ...
    private static final Map<String, ASN1ObjectIdentifier> oidMap = Collections.unmodifiableMap(new HashMap<String, ASN1ObjectIdentifier>() {
        /* class com.mi.car.jsse.easysec.crypto.util.SSHNamedCurves.AnonymousClass1 */
    ...
    private static final Map<ASN1ObjectIdentifier, String> oidToName = Collections.unmodifiableMap(new HashMap<ASN1ObjectIdentifier, String>() {
        /* class com.mi.car.jsse.easysec.crypto.util.SSHNamedCurves.AnonymousClass4 */

        {
            for (String key : SSHNamedCurves.oidMap.keySet()) {
                put(SSHNamedCurves.oidMap.get(key), key);
            }
        }
    });
