...
import com.mi.car.jsse.easysec.crypto.signers.ECGOST3410Signer;
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.util.ECUtil;
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.util.GOST3410Util;
import com.mi.car.jsse.easysec.jce.interfaces.ECKey;
import com.mi.car.jsse.easysec.jce.interfaces.ECPublicKey;
import com.mi.car.jsse.easysec.jce.interfaces.GOST3410Key;
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            try
            {
                ...
                publicKey = EasysecProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes));
