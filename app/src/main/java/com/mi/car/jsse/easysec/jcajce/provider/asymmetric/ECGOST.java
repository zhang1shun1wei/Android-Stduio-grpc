...
import com.mi.car.jsse.easysec.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
...
public class ECGOST
{
    private static final String PREFIX_COMMON = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".ec.";
    private static final String PREFIX = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".ecgost.";
    private static final String PREFIX_GOST_2012 = "com.mi.car.jsse.easysec.jcajce.provider.asymmetric" + ".ecgost12.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            registerOid(provider, RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256,
                    "ECGOST3410-2012",
                    new com.mi.car.jsse.easysec.jcajce.provider.asymmetric.ecgost12.KeyFactorySpi());
