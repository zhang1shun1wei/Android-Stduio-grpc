...
public class EC5Util
{
        ...
        X962Parameters params, ECCurve curve)
    {
        ...
        if (params.isNamedCurve())
        {
            ...
            if (ecP == null)
            {
                Map additionalECParameters = EasysecProvider.CONFIGURATION.getAdditionalECParameters();
    ...
    public static com.mi.car.jsse.easysec.jce.spec.ECParameterSpec convertSpec(ECParameterSpec ecSpec)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        com.mi.car.jsse.easysec.math.ec.ECPoint g = convertPoint(curve, ecSpec.getGenerator());
        ...
        {
            return new com.mi.car.jsse.easysec.jce.spec.ECNamedCurveParameterSpec(((ECNamedCurveSpec)ecSpec).getName(), curve,
                g, n, h, seed);
        }
        else
        {
            return new com.mi.car.jsse.easysec.jce.spec.ECParameterSpec(curve, g, n, h, seed);
        }
    }

    public static com.mi.car.jsse.easysec.math.ec.ECPoint convertPoint(ECParameterSpec ecSpec, ECPoint point)
    {
        return convertPoint(convertCurve(ecSpec.getCurve()), point);
    }

    public static com.mi.car.jsse.easysec.math.ec.ECPoint convertPoint(ECCurve curve, ECPoint point)
    {
        return curve.createPoint(point.getAffineX(), point.getAffineY());
    }

    public static ECPoint convertPoint(com.mi.car.jsse.easysec.math.ec.ECPoint point)
    {
