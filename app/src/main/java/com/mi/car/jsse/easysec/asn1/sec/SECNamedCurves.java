...
import com.mi.car.jsse.easysec.math.ec.ECCurve.F2m;
import com.mi.car.jsse.easysec.math.ec.ECCurve.Fp;
...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() {
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurve(new Fp(p, a, b, n, h, true));
        }
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() {
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurveGLV(new Fp(p, a, b, n, h, true), glv);
        }
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() {
        protected ECCurve createCurve() {
            ...
            return SECNamedCurves.configureCurve(new F2m(m, k, a, b, n, h));
        }
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
        protected ECCurve createCurve() {
            ...
            BigInteger h = BigInteger.valueOf(2L);
            return SECNamedCurves.configureCurve(new F2m(m, k1, k2, k3, a, b, n, h));
        }
