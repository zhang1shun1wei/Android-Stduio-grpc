...
public class ECUtil
{
    ...
    public static ECDomainParameters getDomainParameters(
        ...
        com.mi.car.jsse.easysec.jce.spec.ECParameterSpec params)
    {
        ...
        {
            com.mi.car.jsse.easysec.jce.spec.ECParameterSpec iSpec = configuration.getEcImplicitlyCa();
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            ...
            try
            {
                ...
                PublicKey publicKey = EasysecProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes));
        ...
        throws InvalidKeyException
    {
        if (key instanceof ECPrivateKey)
        {
            ...
            if (s == null)
            {
                s = EasysecProvider.CONFIGURATION.getEcImplicitlyCa();
            }
        ...
        else
        {
            ...
            try
            {
                ...
                PrivateKey privateKey = EasysecProvider.getPrivateKey(PrivateKeyInfo.getInstance(bytes));
        ...
        ECParameterSpec ecParameterSpec)
    {
        for (Enumeration names = ECNamedCurveTable.getNames(); names.hasMoreElements();)
        {
            ...
            {
                return com.mi.car.jsse.easysec.asn1.x9.ECNamedCurveTable.getOID(name);
            }
        }
    ...
    public static String privateKeyToString(String algorithm, BigInteger d, com.mi.car.jsse.easysec.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();

        com.mi.car.jsse.easysec.math.ec.ECPoint q = new FixedPointCombMultiplier().multiply(spec.getG(), d).normalize();
    ...
    public static String publicKeyToString(String algorithm, com.mi.car.jsse.easysec.math.ec.ECPoint q, com.mi.car.jsse.easysec.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();
    ...
    public static String generateKeyFingerprint(ECPoint publicPoint, com.mi.car.jsse.easysec.jce.spec.ECParameterSpec spec)
    {
