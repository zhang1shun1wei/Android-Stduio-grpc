...
public class SRP6Server {
    ...
    public void init(BigInteger N2, BigInteger g2, BigInteger v2, Digest digest2, SecureRandom random2) {
        this.N = N2;
        this.g = g2;
        this.v = v2;
        this.random = random2;
    ...
    public void init(SRP6GroupParameters group, BigInteger v2, Digest digest2, SecureRandom random2) {
