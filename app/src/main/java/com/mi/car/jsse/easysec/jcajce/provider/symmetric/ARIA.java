...
import com.mi.car.jsse.easysec.crypto.engines.ARIAWrapEngine;
import com.mi.car.jsse.easysec.crypto.engines.ARIAWrapPadEngine;
import com.mi.car.jsse.easysec.crypto.engines.RFC3211WrapEngine;
...
import com.mi.car.jsse.easysec.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import com.mi.car.jsse.easysec.jcajce.provider.symmetric.util.GcmSpecUtil;
...
public final class ARIA
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new com.mi.car.jsse.easysec.crypto.macs.Poly1305(new ARIAEngine()));
        }
    }
